                        ...
                        <div class="white-box">
                            <form action="ChangePassword.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="password" name="currentpass" class="form-control ChangePass" id="InputPassword1"
                                        aria-describedby="emailHelp" placeholder="Current Password " required>
                                </div>
                                <div class="form-group">
                                    <label for="password2">New Password</label>
                                    <input  type="password" name="newpass" class="form-control ChangePass" id="InputPassword2"
                                        placeholder="New Password" required>
                                </div>
                                <div class="form-group">
                                    <label for="password3">Confirm New Password</label>
                                    <input  type="password" name="newcpass"  class="form-control ChangePass" id="InputPassword3"
                                        placeholder="Confirm New Password" required>
                                </div>
                                <button type="submit"  class="btn btn-primary ChangePass">Change</button>
                            </form>
                        </div>
                    </div>
                </div>
