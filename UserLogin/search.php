...
<hr>
                                ...
                                <center><h2 class="Heading-Q" style="font-size: 25px;" >Search Results...</h2></center>
                            <?php 
                  include "db_conn.php";
                try{
$search=mysqli_real_escape_string($conn,trim($_POST['searchterm']));
$find_Quer=mysqli_query($conn,"select Question,Answer,DATE_FORMAT(Time,'%d %M %Y') as time  from qna where `Question` like '%$search%'");
  $rowcount=mysqli_num_rows($find_Quer);
if($rowcount==0)
{
  echo "<center>No Search Found...</center>";
}
else{
while ($row=mysqli_fetch_assoc($find_Quer)) {
...
catch(Exception $ex)
{
  ...
  <div class="modal fade" id="RegiModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header text-center">
                                 <h5 class="modal-title w-100" id="exampleModalLabel">Visitor Registration</h5>
                                 <button type="button" class="btn-close" aria-label="Close"
                                    data-dismiss="modal"></button>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-3">
                  <h3>Find Your Way</h3>
                  <ul class="link_menu">
                     <li><a href="http://localhost/GpkOneTouch/userLogin/home.php"><i class="fa fa-chevron-right" aria-hidden="true"></i> Home</a></li>
                     <li><a href="http://localhost/GpkOneTouch/userLogin/about.html"><i class="fa fa-chevron-right" aria-hidden="true"></i>  About</a></li>
                     
                     <li><a href="http://localhost/GpkOneTouch/userLogin/contact.html"><i class="fa fa-chevron-right" aria-hidden="true"></i>  Contact Us</a></li>
                  </ul>
               </div>
                 <div class="col-md-2">
                  <h3>Quick Link</h3>
